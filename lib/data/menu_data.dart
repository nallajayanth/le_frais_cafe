...
class MenuData {
  static final List<MenuItem> appetizers = [
    ...
    MenuItem(
      ...
      price: 90,
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUkIApuV5WMcEcBbxPp7w1Qj3UtJxCbrspWA&s',
      category: 'Appetizers',
      isVeg: true,
      tag: 'SPICY',
      rating: 4.7,
    ...
    MenuItem(
      ...
      price: 180,
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTt97Ljw5a9emkaWYZtwEN8JHiBUqlyBImhhg&s',
      category: 'Appetizers',
      isVeg: true,
      rating: 4.6,
    ),
  ...
  static final List<MenuItem> rice = [
    ...
    MenuItem(
      ...
      price: 110,
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfeUzevM7ZwGohWi79gbdaV2fLT-_i_cg4pg&s',
      category: 'Rice',
      isVeg: true,
      rating: 4.8,
    ),
